...
def price_to_tick(p):
    print(math.floor(math.log(p, 1.0001)))
...
sqrt_low = price_to_sqrtp(price_low)
sqrt_current = price_to_sqrtp(price_current)
sqrt_high = price_to_sqrtp(price_high)
...
liq0 = liquidity0(amount_eth, sqrt_current, sqrt_high)
liq1 = liquidity1(amount_usdc, sqrt_current, sqrt_low)
liq = int(min(liq0, liq1))
print(liq)
